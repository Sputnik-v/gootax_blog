...
@section('content')
    <form action="{{route('update-user.update', [request('id')])}}" method="POST" enctype="multipart/form-data">

        @csrf
        <div class="heading text-center font-bold text-2xl m-5 text-gray-800 bg-white">Update User</div>
