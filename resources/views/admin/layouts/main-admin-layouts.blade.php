                ...
                <div class="navbar-item dropdown has-divider has-user-avatar">
                    <a class="navbar-link">
                        <div class="user-avatar">
                            <img src="{{ asset('storage/' . $admin->image)  }}" alt="admin" class="rounded-full">
                        </div>
                        <div class="is-user-name"><span>{{$admin->name}}</span></div>
                        <span class="icon"><i class="mdi mdi-chevron-down"></i></span>
                    </a>
                    <div class="navbar-dropdown">
                        <a href="{{route('account.showAccount')}}" class="navbar-item">
