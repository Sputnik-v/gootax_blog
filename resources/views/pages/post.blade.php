                    ...
                    <div class="text-right mx-4 mt-4">
                        <div class="flex justify-end items-center gap-2">
                            <form name="like" id="like-form" method="POST" action="{{route('storeLike', ['id' => $post->id])}}">
                                @csrf
                                <button type="submit" class="flex justify-center px-2 gap-2 text-blue-500 rounded border border-transparent hover:border hover:border-blue-500 hover:bg-blue-400 hover:text-white">
                            ...
                            <form name="not_like" id="not_like-form" method="POSt" action="{{route('storeNotLike', ['id' => $post->id])}}">
                                @csrf
                                <button type="submit" class="flex justify-center gap-2 px-2 text-gray-500 rounded border border-transparent hover:border hover:border-gray-800 hover:bg-gray-500 hover:text-white">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
